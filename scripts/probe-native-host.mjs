#!/usr/bin/env node
// TF-115 end-to-end probe: forks the built native inference host under plain
// Node (advanced serialization = structured clone, matching utilityProcess
// semantics), loads a pinned Sherpa model, synthesizes a sentence, and
// reports timing + sample count.
